...
namespace SchoolNumber2
{
    public partial class FinalGradeForm : Form
    {
        ...
        private void FinalGradeForm_Load(object sender, EventArgs e) // Ищем за какой класс для ученика выдать оценки.
        {
            ...
            int val = 0;
            for (int i = 0; i < countClass.Length; i++) // Из значения класса извлекаем цифру(int) 
            {
        ...
        {
            tbMatematika.Text = string.Empty;
            tbRusskiyYaz.Text = string.Empty;
            tbRodnoyYzChuv.Text = string.Empty;
            tbRodnoyYazRuss.Text = string.Empty;
            tbLiteratura.Text = string.Empty;
            tbChtenRodYazChuv.Text = string.Empty;
            tbChtenRodYazRuss.Text = string.Empty;
            tbInostYazEng.Text = string.Empty;
            tbOkrMir.Text = string.Empty;
            tbOsnovReligSvetskEtiki.Text = string.Empty;
            tbMuzika.Text = string.Empty;
            tbIZO.Text = string.Empty;
            tbFIZRA.Text = string.Empty;
            tbTechnology.Text = string.Empty;
            tbHistCultRodnKray.Text = string.Empty;
            tbGosYazChuv.Text = string.Empty;
            tbOsnDuxKultRuss.Text = string.Empty;
            tbOsnovReligSvetskEtiki.Text = string.Empty;
            tbRodnoyYazRuss.Text = string.Empty;
            tbRodnoyYzChuv.Text = string.Empty;
            tbShahmate.Text = string.Empty;
            tbVtoroyInostYazGer.Text = string.Empty;
            tbXimia.Text = string.Empty;
            tbFizika.Text = string.Empty;
            tbGeography.Text = string.Empty;
            tbGeometry.Text = string.Empty;
            tbInformatika.Text = string.Empty;
            tbAlgebra.Text = string.Empty;
            tbHistRussVseOHistr.Text = string.Empty;
            tbObshestvo.Text = string.Empty;
            tbBiology.Text = string.Empty;
            tbOBZ.Text = string.Empty;
            tbMoyGorod.Text = string.Empty;
            tbAnalizTeksta.Text = string.Empty;
            tbAstronomy.Text = string.Empty;
            tbEconomica.Text = string.Empty;
            tbPravo.Text = string.Empty;
            tbHistory.Text = string.Empty;
            tbAlgebraProff.Text = string.Empty;

            cbClass.Text = string.Empty;
            cbQuarter.Text = string.Empty;
        ...
        {
            if (cbQuarter.Text != string.Empty && cbClass.Text != string.Empty)
            {
